...
| --- | --- | --- | --- | --- | --- | --- |
| plastic_green_pumpkin | Green pumpkin | soft_plastic | opaque / flake | Opaque soft plastic; green pumpkin body with separate black flakes. | documented_palette | Yes |
...
| jig_brown | Brown | skirt_and_plastic | opaque / mixed | Brown skirt with a brown trailer; coordinated head. | editorial_recipe | Yes |
| jig_brown_orange | Brown / orange craw | skirt_and_plastic | opaque / mixed | Brown with orange accents skirt with a brown trailer; coordinated head. | editorial_recipe | Yes |
| jig_black_blue | Black / blue | skirt_and_plastic | opaque / mixed | Black and blue skirt with a black with blue flake trailer; coordinated head. | editorial_recipe | Yes |
...
| hair_white | White | hair_feather | sparse_fiber / matte | White hair or marabou dressing; no plastic flakes or silicone skirt. | documented_palette | Yes |
| hair_white_chartreuse | White / chartreuse | hair_feather | sparse_fiber / matte | White with chartreuse accents hair or marabou dressing; no plastic flakes or silicone skirt. | editorial_recipe | Yes |
| hard_ghost | Ghost minnow | hard_finish | translucent / satin | Transparent smoke sides, gray back and translucent white belly; satin finish. | documented_palette | Yes |
| hard_silver_black | Silver / black | hard_finish | opaque / metallic | Silver sides, black back and silver belly; metallic finish. | documented_palette | Yes |
| hard_silver_blue | Silver / blue | hard_finish | opaque / metallic | Silver sides, blue back and silver belly; metallic finish. | documented_palette | Yes |
| hard_gold_black | Gold / black | hard_finish | opaque / metallic | Gold sides, black back and gold belly; metallic finish. | documented_palette | Yes |
| hard_pearl | Pearl baitfish | hard_finish | opaque / pearl | Pearl white sides, gray back and white belly; pearl finish. | documented_palette | Yes |
| hard_perch | Perch pattern | hard_finish | opaque / satin | Olive yellow with dark bars sides, olive back and yellow belly; satin finish. | editorial_recipe | Yes |
| hard_bluegill | Bluegill pattern | hard_finish | opaque / satin | Olive brown with subtle bars sides, olive back and muted orange belly; satin finish. | editorial_recipe | Yes |
...
| metal_gold | Gold / brass | metal | opaque / metallic | Gold metal lure surface; metallic finish. Hook stays neutral. | editorial_recipe | Yes |
| metal_copper | Copper | metal | opaque / metallic | Copper metal lure surface; metallic finish. Hook stays neutral. | editorial_recipe | Yes |
...
| buzz_white | White | mixed_blade | opaque / mixed | Skirt: white; Trailer: white. Preserve distinct colored areas and the selected bait construction. | editorial_recipe | Yes |
| buzz_black | Black | mixed_blade | opaque / mixed | Skirt: black; Trailer: black. Preserve distinct colored areas and the selected bait construction. | editorial_recipe | Yes |
| buzz_chartreuse | Chartreuse | mixed_blade | opaque / mixed | Skirt: chartreuse; Trailer: chartreuse. Preserve distinct colored areas and the selected bait construction. | editorial_recipe | Yes |
...
| tailspin_chartreuse | Chartreuse | mixed_blade | opaque / mixed | Body: chartreuse; Tail: neutral hook. Preserve distinct colored areas and the selected bait construction. | editorial_recipe | Yes |
| frog_black | Black belly | soft_plastic | opaque / satin | Black frog/toad back and legs with a clearly visible black underside. | editorial_recipe | Yes |
| frog_white | White belly | soft_plastic | opaque / satin | Olive green frog/toad back and legs with a clearly visible white underside. | editorial_recipe | Yes |
| frog_yellow | Green / yellow belly | soft_plastic | opaque / satin | Olive green frog/toad back and legs with a clearly visible yellow underside. | editorial_recipe | Yes |
| frog_brown | Brown frog | soft_plastic | opaque / satin | Brown frog/toad back and legs with a clearly visible tan underside. | editorial_recipe | No |
| toad_black | Black belly | soft_plastic | opaque / satin | Black frog/toad back and legs with a clearly visible black underside. | editorial_recipe | Yes |
| toad_white | White | soft_plastic | opaque / satin | Solid white soft-plastic toad body and legs, including the underside; no invented green back or belly stripe. | editorial_recipe | Yes |
| toad_yellow | Green / yellow belly | soft_plastic | opaque / satin | Olive green frog/toad back and legs with a clearly visible yellow underside. | editorial_recipe | Yes |
| toad_brown | Brown frog | soft_plastic | opaque / satin | Brown frog/toad back and legs with a clearly visible tan underside. | editorial_recipe | No |
| fly_black | Black | fly_fiber | sparse_fiber / satin | Black upper fibers/head and tail with black lower body; restrained flash only where the selected fly construction calls for it. | documented_palette | Yes |
| fly_olive | Olive | fly_fiber | sparse_fiber / satin | Olive upper fibers/head and tail with olive lower body; restrained flash only where the selected fly construction calls for it. | documented_palette | Yes |
| fly_brown | Brown | fly_fiber | sparse_fiber / satin | Brown upper fibers/head and tail with brown lower body; restrained flash only where the selected fly construction calls for it. | documented_palette | Yes |
| fly_tan | Tan | fly_fiber | sparse_fiber / satin | Tan upper fibers/head and tail with tan lower body; restrained flash only where the selected fly construction calls for it. | editorial_recipe | Yes |
| fly_white | White | fly_fiber | sparse_fiber / satin | White upper fibers/head and tail with white lower body; restrained flash only where the selected fly construction calls for it. | documented_palette | Yes |
| fly_olive_white | Olive / white | fly_fiber | sparse_fiber / satin | Olive upper fibers/head and tail with white lower body; restrained flash only where the selected fly construction calls for it. | documented_palette | Yes |
| fly_gray_white | Gray / white | fly_fiber | sparse_fiber / satin | Gray upper fibers/head and tail with white lower body; restrained flash only where the selected fly construction calls for it. | editorial_recipe | Yes |
| fly_black_purple | Black / purple | fly_fiber | sparse_fiber / satin | Purple upper fibers/head and tail with black lower body; restrained flash only where the selected fly construction calls for it. | editorial_recipe | Yes |
| fly_chartreuse_white | Chartreuse / white | fly_fiber | sparse_fiber / satin | Chartreuse upper fibers/head and tail with white lower body; restrained flash only where the selected fly construction calls for it. | editorial_recipe | Yes |
| fly_rust | Rust orange | fly_fiber | sparse_fiber / satin | Brown orange upper fibers/head and tail with brown orange lower body; restrained flash only where the selected fly construction calls for it. | documented_palette | No |
| flash_silver_gold | Silver / gold flash | fly_flash | sparse_fiber / metallic | Gold upper flash fibers over silver reflective fibers; a flash-dominant streamer, not an opaque painted lure. | documented_palette | Yes |
| flash_copper_gold | Copper / gold flash | fly_flash | sparse_fiber / metallic | Copper upper flash fibers over gold reflective fibers; a flash-dominant streamer, not an opaque painted lure. | documented_palette | Yes |
| flash_purple_copper | Purple / copper flash | fly_flash | sparse_fiber / metallic | Purple upper flash fibers over copper reflective fibers; a flash-dominant streamer, not an opaque painted lure. | editorial_recipe | Yes |
| flash_copper_gold_silver | Copper / gold / silver flash | fly_flash | sparse_fiber / metallic | Copper and gold upper flash fibers over silver reflective fibers; a flash-dominant streamer, not an opaque painted lure. | documented_palette | Yes |
| popper_white | White | fly_popper | opaque / satin | White cupped fly-popper body with white dressed tail and barred legs; single fly hook. | editorial_recipe | Yes |
| popper_black | Black | fly_popper | opaque / satin | Black cupped fly-popper body with black dressed tail and barred legs; single fly hook. | editorial_recipe | Yes |
| popper_yellow | Yellow | fly_popper | opaque / satin | Yellow cupped fly-popper body with yellow dressed tail and barred legs; single fly hook. | editorial_recipe | Yes |
...
| bucktail_black_white | Black / white dots | mixed_blade | opaque / mixed | Black painted spinner blade with distinct white dots, black body and black hair dressing. | editorial_recipe | Yes |
