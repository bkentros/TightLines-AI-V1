# Largemouth V3 Gold Batch 2 Review Sheet

Generated: 2026-04-14T00:40:25.496Z
Archive bundle generated: 2026-04-04T02:12:39.734Z
Scenario count: 10
Contexts: 7 lake/pond, 3 river
Priority mix: 7 core, 3 secondary
...
- Late-fall largemouth should slow some, but Delta-style stained water still needs visible horizontal or cover-oriented lanes.
...
- Noon air temp: 67.9 F
- Noon pressure: 1023.1 mb
- Noon cloud cover: 5%
- Daily high/low: 69 / 56.3 F
- Daily wind max: 10.4 mph
- Daily precip: 0.003937007874015749 in
- Moon phase: Waning Gibbous
- Sunrise/sunset: 06:36 / 17:03
...
Expected seasonal story:
- Florida prespawn largemouth should lean baitfish and craw transition lanes without jumping straight into pure surface behavior.
Expected primary lanes:
- suspending_jerkbait
- paddle_tail_swimbait
- spinnerbait
...
- Label: Florida grass lake largemouth, early-summer vegetation window
- Priority: core
- Date: 2025-06-18
- State: FL
- Context: freshwater_lake_pond
...
Expected seasonal story:
- Early-summer Florida largemouth should open grass and surface-adjacent lanes while still respecting cover-oriented backup options.
Expected primary lanes:
- hollow_body_frog
- swim_jig
- walking_topwater
...
Actual output:
- Top 1 lure: Buzzbait `buzzbait` | theme: `bright` | colors: white/chartreuse, chartreuse, firetiger
- Top 3 lures:
...
Expected seasonal story:
- Florida fall largemouth should allow stronger shallow baitfish and surface-cover options than the summer slowdown windows.
Expected primary lanes:
- walking_topwater
- swim_jig
- spinnerbait
...
- Label: Texas reservoir largemouth, spawn-to-postspawn transition
- Priority: core
- Date: 2025-04-16
- State: TX
- Context: freshwater_lake_pond
...
Expected seasonal story:
- River largemouth in prespawn should use current seams and softer edges with moving search lanes that still feel river-specific.
Expected primary lanes:
- spinnerbait
- swim_jig
- soft_jerkbait
...
Expected seasonal story:
- Early-fall river largemouth should open horizontal baitfish lanes around current edges without losing river-specific control.
Expected primary lanes:
- spinnerbait
- paddle_tail_swimbait
- squarebill_crankbait
...
Expected seasonal story:
- Late-fall southern grass largemouth should slow some, but still favor visible shallow cover and horizontal baitfish lanes over dead winter behavior.
Expected primary lanes:
- bladed_jig
- spinnerbait
- compact_flipping_jig
...
Expected seasonal story:
- Cold clear Ozarks largemouth should stay disciplined around jerkbait, flat-side, and jig lanes instead of jumping too shallow or too loud.
Expected primary lanes:
- suspending_jerkbait
- flat_sided_crankbait
- football_jig
