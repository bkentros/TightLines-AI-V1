...
> **Scoring v3 Pass 2 internal implementation complete — 2026-09-14:** The [Pass 2 completion report](onboarding/piercast/scoring-v3-pass2/PASS2_COMPLETION_REPORT.md) implements the 36 admitted calibrations and 98 modes as a generated, hash-pinned, owner-only Formula v3 shadow engine. The exact equation is `1 + (seasonalPotential - 1) × (0.30 + 0.70 × temperatureSuitability)` with maximum single-mode selection and no stacking. The exhaustive audit passes 65,700 full-year invariant scores and a 9,360-row v2/v3 replay is frozen. A separate 180-forecast nine-city ledger and fail-closed same-issue ingestion path are migration-ready. Formula v2, public release, historical snapshots, and leaderboards remain unchanged. External specialist review, field representation validation, prospective outcomes, deployment, and explicit owner promotion remain gates—not completed claims.

> **Scoring v3 Pass 1 complete — 2026-09-14:** The [completion report](onboarding/piercast/scoring-v3-pass1/PASS1_COMPLETION_REPORT.md) resolves all nine cities × thirteen species: 36 Grade A/B core-salmonid pairs receive 98 disabled opportunity-mode calibrations, 29 Grade C pairs are deferred without v3 numbers, and 52 Grade D pairs are excluded from current scope. The full-year matrix contains 6,084 review rows and the normalized claim ledger contains 850 source uses. Formula v2, runtime imports, release flags, databases, leaderboards, and historical snapshots remain unchanged. External specialist review, Formula v3 implementation, environmental representation validation, and prospective outcomes remain Pass 2 promotion gates.
...
> **Phase 2 final onboarding — 2026-09-12:** [Final decisions](onboarding/piercast/remaining-species/PHASE2_ONBOARDING_DECISIONS.md) admit seven additions into the private provisional scored lineup: Ludington smallmouth/perch; Grand Haven drum/largemouth; Manistee lake trout/drum/perch. All 45 pairings have an admission or explicit deferral (38 deferred; nine retain annual research). The 27 city/species lineup has full-year curves, thermal profiles, versioned daily snapshots and 135-row shadow runs. Core numeric curves, formula and public/scientific gates remain unchanged. Phase 3 is the annual lineup review together.
...
> **Earlier strict scoring review — superseded for research planning and proposals:** The [45-pair decision register](onboarding/piercast/remaining-species/README.md) supersedes earlier candidate labels for the nine non-core species. That historical review retained three narrow leads and disabled all additional runtime species. Its research conclusions are superseded by the annual Phase 1 package above; the runtime gates remain in force. The existing four-species scores, formula, UI, daily lock, conditions pipeline and disabled public release remain unchanged.
