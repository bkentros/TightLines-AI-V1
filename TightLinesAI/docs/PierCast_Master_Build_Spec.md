...
> **Phase 2 in progress — 2026-09-12:** The [thermal and eligibility research](onboarding/piercast/remaining-species/PHASE2_THERMAL_RESEARCH.md) adds nine explicitly provisional thermal sensitivity candidates, 2,889 sampled fits and 6,656 hypothetical weekly scenarios using the unchanged engine. These are not measured bite functions or runtime approvals. The 16-pair eligibility register retains three named-structure corroborations, five contextual inferences and eight unresolved side attributions. Exact-side/method reconciliation and scientific thermal review remain open; public gates and the completed four-species runtime are unchanged.
