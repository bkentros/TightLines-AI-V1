...
> **Phase 2 private research integration — 2026-09-12:** The [thermal and eligibility report](onboarding/piercast/remaining-species/PHASE2_THERMAL_RESEARCH.md) now connects 14 provisional city/species thermal hypotheses to the owner-only outlook; two round-whitefish pairings retain annual baselines with thermal response deferred. All 16 preserve explicit structure/method/representation gates. The current 2026 regulation guide is preserved and relevant pages checked. Additional research stays outside locked scores, headlines, shadow forecasts and public catalogs. This is private research integration, not validated live activation. Phase 3 reviews the annual lineup with these deferrals visible.
