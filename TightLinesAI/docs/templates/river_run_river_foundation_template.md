...
lifts, closures, removed structures, and proposed changes. A finding of “none
in the relevant corridor” requires evidence; silence does not pass.
...
## 7. Supported species decision

| Species | Biological support | Source support | Planned run | Status | Evidence IDs |
| --- | --- | --- | --- | --- | --- |
| Chinook salmon |  |  | Fall | unresolved |  |
| Coho salmon |  |  | Fall | unresolved |  |
| Steelhead |  |  | Fall entry | unresolved |  |

Unsupported combinations remain visible but disabled in the product catalog
only when that catalog behavior is intentionally configured and tested.
...
| Evidence ID | Authority/title | URL or repository path | Published/updated | Accessed | Facts supported | Geographic reach | Limitations |
| --- | --- | --- | --- | --- | --- | --- | --- |
| E-001 |  |  |  |  |  |  |  |
