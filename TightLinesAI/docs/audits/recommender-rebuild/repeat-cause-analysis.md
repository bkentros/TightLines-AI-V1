...
Generated: **2026-04-26T03:22:02.474Z**

## Executive conclusion

Current production repeats are dominated by **catalog_distribution_limit** in this classifier. Full geometry remains hard-useful as an audit contrast, but it does not erase structural lane repetition; the best next production pass is a hybrid preferred-pool plus group-aware rotation/third-slot rule, not a direct full-geometry switch.
...
| catalog_distribution_limit | 4508 | 58.18% | 4510 | 100% |
| row_menu_limit | 3240 | 41.82% | 0 | 0% |
| selector_choice | 0 | 0% | 0 | 0% |
| unknown_needs_review | 0 | 0% | 0 | 0% |

- Current repeated cells: **6928**; repeat slots: **7748**.
- Geometry repeated cells: **3690**; repeat slots: **4510**.
- Cells repeated in both modes: **3675**.
- Cells repeated only in current mode: **3253** (10.91%).
...
- largemouth_bass: 24.31% repeated cells (2520/10368); dominant row_menu_limit
- smallmouth_bass: 7.94% repeated cells (720/9072); dominant row_menu_limit
- trout: 0% repeated cells (0/4536); dominant single_group_lane
...
- largemouth_bass|freshwater_lake_pond: 24.96% repeated cells (1294/5184); dominant row_menu_limit
- largemouth_bass|freshwater_river: 23.65% repeated cells (1226/5184); dominant row_menu_limit
- smallmouth_bass|freshwater_lake_pond: 15.87% repeated cells (720/4536); dominant row_menu_limit
- smallmouth_bass|freshwater_river: 0% repeated cells (0/4536); dominant single_group_lane
- trout|freshwater_river: 0% repeated cells (0/4536); dominant single_group_lane
...
- northern_pike|appalachian|freshwater_lake_pond|1: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|great_lakes_upper_midwest|freshwater_river|1: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|great_lakes_upper_midwest|freshwater_lake_pond|2: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|inland_northwest|freshwater_river|1: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|midwest_interior|freshwater_river|1: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|mountain_alpine|freshwater_river|2: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|mountain_alpine|freshwater_river|11: 100% repeated cells (27/27); dominant catalog_distribution_limit
- northern_pike|northeast|freshwater_river|1: 100% repeated cells (27/27); dominant catalog_distribution_limit
...
| largemouth_bass|freshwater_lake_pond|surface|slow | 0.68 | 1.44 | 1.08 | 2.17 | 41.67% |
| largemouth_bass|freshwater_lake_pond|surface|medium | 0.68 | 1.44 | 1.08 | 2.17 | 41.67% |

## Target Profile Geometry

- Duplicate lane profile rate: **56.48%**.
- Duplicate column profile rate: **59.52%**.
- Current repeated cells with duplicate lanes: **94.95%**.
- Current repeated cells with duplicate columns: **95.54%**.
- Current rows capable of 3 lure macro groups: **100%**.
- Current rows capable of 3 fly macro groups: **97.58%**.
- Geometry capable of 3 lure macro groups: **100%**.
- Geometry capable of 3 fly macro groups: **97.58%**.

## Dominant Issue

The dominant automated cause is **catalog_distribution_limit**. Row menus matter where geometry expands a lane, but profile geometry and catalog lane distribution still cap macro diversity in many repeated cells. A pure catalog-wide pool therefore improves some lane availability without solving repeated profile asks.

## Strategy Evaluation

- **A_manual_row_menu_repair**: Targets 3240 row-menu-limited repeat slots in this run; safe, but not the main lever unless humans identify biologically wrong row menus outside this classifier.
...
- **dominant_constraint_estimate**: {"row_menu_limit_slots":3240,"selector_choice_slots":0,"profile_geometry_repeat_slots":0,"catalog_distribution_limit_slots":4508}
