...
| Historical opportunity tier/ceiling | **Calibrated Moderate ceiling, 7/10 for fall entry.** Webber's 164 fall fish are an upstream partial count. Current stocking, recurring Grand fishery evidence, and portfolio comparisons support 7/10 without importing the larger spring run. | S-R002, S-CAL01            | hidden_review_calibrated       |
...
| ---------------------------- | ----- | ------------------------------------------------------------------------------------------ | -------------- | ------------------ |
| Pre-run monitoring start     | 09-01 | Begin observing before documented September passage reaches Webber                         | S-R002         | yes                |
| Staging start                | 09-10 | Early fall Steelhead may be nearby; do not infer strain identity or dependable river entry | S-R002, S-R003 | yes                |
| River-run start              | 09-15 | Sparse lower-river opening consistent with September fish 102 miles upstream               | S-R002         | yes                |
| Beginning end                | 09-30 | September remains a small early component                                                  | S-R002         | yes                |
| Established building start   | 10-01 | Build toward DNR's late-October statewide entry window                                     | S-R001, S-R002 | yes                |
| Broad building start         | 10-20 | Wider distribution only where current passage supports it                                  | S-R001, S-R002 | yes                |
...
| -------------- | ------------ | ------------------- | --------------------------------------------- | ------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| offseason      | 02-01–08-31  | Fall entry complete | none                                          | none                                                          | `Fall Steelhead entry tracking is complete.` Why: this profile resumes in September; Steelhead may still persist or move in other seasons.     | `Check back in September when fall movement tracking resumes.`                            | Does not say fish left or died; no unavailable spring handoff. |
| before_staging | 09-01–09-09  | Not staging yet     | none                                          | none                                                          | `Dependable fall entry is not expected yet.` Why: monitoring has begun, but the staging checkpoint has not arrived.                            | `Wait for the staging window before using this fall-entry outlook.`                       | Monitoring is not evidence of fish.                            |
| staging        | 09-10–09-14  | Staging             | Grand Haven harbor and pierheads context only | none                                                          | `Early Steelhead may be staging near the river mouth.` Why: early fish are exceptions before dependable fall entry.                            | `Keep expectations narrow and wait for the fall-entry phase before using river sections.` | No strain inference.                                           |
| beginning      | 09-15–09-30  | Beginning           | Lower river                                   | none                                                          | `The first lower-river Steelhead window is opening.` Why: September passage reached Webber historically, while the main entry window is later. | `Begin in the Lower river and keep the plan narrow.`                                      | No confirmed live entry.                                       |
| building_early | 10-01–10-19  | Building            | Lower river                                   | Middle passage corridor only after current route verification | `The fall Steelhead window is building.` Why: timing is approaching the normal late-October entry period.                                      | `Keep Lower first; add Middle only when current passage information confirms the route.`  | Historic passage is not current route proof.                   |
| building_broad | 10-20–10-31  | Building            | Lower river                                   | verified Middle passage corridor                              | `Seasonal timing supports a broader Steelhead window.` Why: late October begins the established statewide migration period.                    | `Start Lower, then compare verified Middle water.`                                        | Upper remains withheld pending the full passage chain.         |
...
- Curve candidate: `grand-steelhead-fall-presence-v2-draft`.
- Direction: rising 09-15–11-14; peak 11-15; falling entry signal 11-16–12-31;
...
| Day offset from 09-15 | Fraction of maximum | Reason                                                            | Evidence IDs   |
| --------------------: | ------------------: | ----------------------------------------------------------------- | -------------- |
|                     0 |                0.05 | Sparse September opening                                          | S-R002         |
|                    15 |                0.12 | Small historic September component                                | S-R002         |
|                    30 |                0.30 | October build                                                     | S-R001, S-R002 |
|                    40 |                0.50 | Established late-October entry                                    | S-R001         |
|                    47 |                0.72 | November-weighted Grand passage begins                            | S-R002         |
|                    61 |                1.00 | November peak anchor                                              | S-R002         |
|                    76 |                0.88 | End of dominant historic month                                    | S-R002         |
|                    91 |                0.72 | Entry taper with persistence                                      | S-R001         |
|                   107 |                0.62 | Fall-entry end; overwintering fish may remain                     | S-R001         |
|                   122 |                0.58 | Holding plateau, not active movement                              | S-R001         |
|                   138 |                0.00 | Profile complete; public output must not imply biological absence | S-R001         |
