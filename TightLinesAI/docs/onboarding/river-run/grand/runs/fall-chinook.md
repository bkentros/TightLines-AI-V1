...
and alias searches were checked. They establish recurring Chinook passage and a
...
> accessible corridor. Foundation evidence IDs resolve in
> `../river-foundation.md`.
...
`Chinook guidance ends at Webber Dam. Passage into
...
Public Activity scope note:
`Responsiveness if Chinook are present—not
...
- Permanent scope note:
  `Fishability describes the Fulton Street reach only;
