# PierCast Prospective Evaluation Protocol v1

**Re-frozen:** 2026-09-10 after the formula-v2 decision and before the first outcome was recorded<br>
**Forecast cohort:** engine `pier-cast-simple-model-v0.7.0`, active formula `seasonal-opportunity-bounded-temperature-v2`, same-issue comparator `seasonal-ceiling-x-temperature-v1`, seasonal calibration `piercast-core-seasonal-v0.3.0`, temperature calibration `piercast-core-temperature-v0.2.0`, and rating rubric `finfindr-opportunity-v1`<br>
