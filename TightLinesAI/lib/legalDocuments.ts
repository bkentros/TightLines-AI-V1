    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Migration Stage, Activity Outlook, Seasonal Presence, Gauge Read, Fish Counts, and a Spot Finder recommendation do not determine whether a trip, access point, route, crossing, launch, wade, or waterbody is safe.',
