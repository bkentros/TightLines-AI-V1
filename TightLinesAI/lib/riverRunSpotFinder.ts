...
export const RIVER_RUN_SPOT_FINDERS: Record<string, RiverSpotFinder> = {
    ...
    sections: [
      {
        ...
        spots: [{
          id: "salmon_ny_route_3",
          name: "Route 3 Fishing Access",
          accessKinds: ["fishing_platform", "walk_in", "shore_fishing"],
          detail: "NYSDEC-listed Port Ontario access with an accessible fishing/viewing platform and walking path.",
          caution: "Use the marked access and confirm estuary water, parking, and posted boundary conditions on arrival.",
          sourceLabel: "New York State Department of Environmental Conservation",
          sourceUrl: "https://dec.ny.gov/places/salmon-river",
          sourceLocator: "Open Access, then Accessible Features; find Route 3 Parking Area in Port Ontario.",
      ...
      },
      {
        ...
        spots: [{
          id: "salmon_ny_trout_brook",
          name: "Trout Brook Access",
          accessKinds: ["shore_fishing", "walk_in"],
          detail: "NYSDEC-listed fishing location with Route 48 parking in the middle mainstem corridor.",
          caution: "Public Fishing Rights are narrow fishing easements; stay within signs and do not assume neighboring land is public.",
          sourceLabel: "New York State Department of Environmental Conservation",
          sourceUrl: "https://dec.ny.gov/places/salmon-river",
          sourceLocator: "Open Access and find Trout Brook — Route 48 — Parking.",
          verifiedOn: "2026-08-31",
        }],
      },
      {
        ...
        spots: [{
          id: "salmon_ny_paradise_pool",
          name: "Paradise Pool Access",
          accessKinds: ["shore_fishing", "walk_in"],
          detail: "NYSDEC-listed upper-river fishing location with Route 22 parking.",
          caution: "Nearby fly sections have distinct dates, hours, tackle, and release rules; the reservoir is outside River Run's corridor.",
          sourceLabel: "New York State Department of Environmental Conservation",
          sourceUrl: "https://dec.ny.gov/places/salmon-river",
          sourceLocator: "Open Access and find Paradise Pool — Route 22 — Parking.",
          verifiedOn: "2026-08-31",
        }],
      },
    ],
    ...
    sections: [
      {
        ...
        spots: [{
          id: "oak_orchard_marine_park",
          name: "Oak Orchard Marine Park",
          accessKinds: ["boat_ramp", "shore_fishing"],
          detail: "NYSDEC PFR mapping identifies the Orleans County marine park and ramp at the Lake Ontario end of the creek.",
          caution: "Harbor access does not establish safe wading or authorize entry on adjacent private shoreline.",
          sourceLabel: "NYSDEC Oak Orchard River Public Fishing Rights",
          sourceUrl: "https://dec.ny.gov/sites/default/files/pfroakorchrv.pdf",
          sourceLocator: "On Map 1, find Oak Orchard Marine Park and Ramp near Point Breeze.",
          verifiedOn: "2026-08-31",
        }],
      },
      {
        ...
        spots: [{
          id: "oak_orchard_pfr_footpaths",
          name: "Oak Orchard PFR Footpaths",
          accessKinds: ["shore_fishing", "walk_in", "wade_access"],
          detail: "NYSDEC maps signed angler parking, public fishing easements, and footpaths through the middle corridor.",
          caution: "Property beyond mapped footpaths is private and requires landowner permission; map widths are not survey boundaries.",
          sourceLabel: "NYSDEC Oak Orchard River Public Fishing Rights",
          sourceUrl: "https://dec.ny.gov/sites/default/files/pfroakorchrv.pdf",
          sourceLocator: "Use Map 1 and its Left Bank PFR, Right Bank PFR, Angler Parking, and Start of Footpath legend.",
          verifiedOn: "2026-08-31",
        }],
      },
      {
        ...
        spots: [{
          id: "oak_orchard_waterport_tailrace",
          name: "Waterport Dam PFR",
          accessKinds: ["shore_fishing", "walk_in", "wade_access"],
          detail: "NYSDEC PFR mapping carries marked fishing easements and footpaths to the Waterport Reservoir Dam endpoint.",
          caution: "High-water overflow channels can strand fish and become hazardous; obey signed dam, private-property, and seasonal boundaries.",
          sourceLabel: "NYSDEC Oak Orchard River Public Fishing Rights",
          sourceUrl: "https://dec.ny.gov/sites/default/files/pfroakorchrv.pdf",
          sourceLocator: "On Map 1, follow marked PFR and footpaths to Waterport Reservoir Dam.",
          verifiedOn: "2026-08-31",
        }],
      },
    ],
  ...
  lower_genesee: {
    ...
    supportedStates: ["NY"],
    orientationNote:
      "Only the source-listed Seth Green–Lower Falls fishing area is recommended. Harbor parks and general river trails were not treated as fishing access without direct fishing proof.",
    safetyLink: {
      label: "CHECK CURRENT NYSDEC TRIBUTARY RULES →",
      url: "https://dec.ny.gov/things-to-do/freshwater-fishing/regulations/great-lakes-tributaries",
    },
