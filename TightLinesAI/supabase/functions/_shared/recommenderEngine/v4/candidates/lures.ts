...
export const LURE_ARCHETYPES_V4: readonly ArchetypeProfileV4[] = [
  ...
  lure({
    ...
    display_name: "Big Smallmouth Tube",
    family_group: "tube_jig",
    presentation_group: "ned_tube_finesse",
    column: "bottom",
    primary_pace: "slow",
  ...
  lure({
    ...
    water_types_allowed: [L],
    how_to_fish_variants: [
      "Reel just fast enough to bulge the surface and leave a steady V-wake; keep the bait coming over points, grass, or shade without twitching it away.",
  ...
  lure({
    ...
    display_name: "Shallow Minnowbait",
    ...
    water_types_allowed: [L, R],
    how_to_fish_variants: [
      "Retrieve the shallow minnowbait over weeds or current edges with steady pulls and pauses so it rolls through the upper-to-mid lane.",
