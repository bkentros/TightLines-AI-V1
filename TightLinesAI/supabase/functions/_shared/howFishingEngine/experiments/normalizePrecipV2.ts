...
/**
 * Experimental Rain / Precip V2.
 *
 * Shadow-only goals:
 * - active_precip_now is context, not severity by itself
 * - p7d creates a wet-baseline penalty for lakes/coast/flats
 * - dry states are small positives only
 * - flats are a little more sensitive than broad coastal
 */
export function normalizePrecipitationDisruptionV2(
  context: PrecipContext,
  ...
  if (
    r24 != null && r72 != null && r24 >= 0.01 && r24 < (coastal ? 0.2 : 0.15)
  ) {
