...
function buildEnvironmentSnapshot(
  ...
  return {
    ...
    storm_risk_later_today: env.storm_risk_later_today ?? null,
    rain_risk_later_today: env.rain_risk_later_today ?? null,
    heavy_rain_later_today: env.heavy_rain_later_today ?? null,
    storm_window_start_local_hour: env.storm_window_start_local_hour ?? null,
    max_precip_probability_pct: env.max_precip_probability_pct ?? null,
