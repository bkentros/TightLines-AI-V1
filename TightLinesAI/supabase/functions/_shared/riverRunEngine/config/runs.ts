...
export const PERE_MARQUETTE_FALL_CHINOOK_RUN_PROFILE: AuditedRiverRunProfile = {
  ...
  historicalPresence: {
    maximum: 10,
    curveVersion: "pm-fall-chinook-presence-v1",
    evidenceNotes:
      "The PM is a signature Great Lakes Chinook river. The initial curve represents low river presence beginning in mid-August, building through September, and declining after the October window.",
    sourceNotes:
    ...
    anchors: [
      ...
      { dayOffsetFromStart: 50, fractionOfMaximum: 0.7 },
      { dayOffsetFromStart: 66, fractionOfMaximum: 0.25 },
      { dayOffsetFromStart: 80, fractionOfMaximum: 0 },
    ],
  },
  push: {
    version: "pm-fall-chinook-push-v3",
    hydraulic: {
      metric: "flow_cfs",
  ...
  fishabilityBands: {
    version: "pm-scottville-fishability-v1",
    metric: "flow_cfs",
    sourceLabel: "Scottville",
    tooLow: { max: 400 },
    lowFishable: { min: 400, max: 475 },
    ...
    evidenceNotes:
      "PM Fall Chinook launch calibration for the lower mainstem represented by Scottville. Modern August 15-October 20 daily means from 2016-2025 (670 days) were approximately p10 416, p25 468, median 536, p75 627, p90 802, p95 1066, and p99 1458 cfs. Configured bands therefore treat below 400 as unusually low, 400-475 as low, 475-525 as workable transition, 525-750 as ideal, 750-1000 as high but fishable, 1000-1600 as very high/difficult, and 1600+ as blown out. These are fishing-shape classifications for this gauge reach, not wading or boating safety thresholds.",
    sourceNotes:
  ...
  researchNotes:
    "Beta launch hypothesis for PM Fall Chinook. The product owner accepted August 15 as the river-window start and a separate late-July staging advisory. The September 20 peak reference, October 20 end, November 3 late end, and presence curve still require PM replay and live-season acceptance before runtime public release.",
  sourceNotes:
