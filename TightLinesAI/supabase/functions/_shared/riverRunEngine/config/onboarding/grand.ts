...
export const GRAND_FALL_CHINOOK_RUN_PROFILE: AuditedRiverRunProfile = {
  ...
  historicalPresence: presence(
    6,
    "sectional",
    "grand-chinook-presence-v1-draft",
    [
    ...
    "Draft 6/10 Lower-first sectional curve uses historic Webber passage timing. Chinook guidance never extends above Webber and Middle remains conditional on the current complete route.",
  ),
...
export const GRAND_FALL_STEELHEAD_RUN_PROFILE: AuditedRiverRunProfile = {
  ...
  historicalPresence: presence(
    5,
    "broad",
    "grand-steelhead-fall-presence-v1-draft",
    [
      { dayOffsetFromStart: 0, fractionOfMaximum: 0.1 },
      { dayOffsetFromStart: 14, fractionOfMaximum: 0.25 },
      { dayOffsetFromStart: 24, fractionOfMaximum: 0.48 },
      { dayOffsetFromStart: 31, fractionOfMaximum: 0.72 },
      { dayOffsetFromStart: 45, fractionOfMaximum: 1 },
      { dayOffsetFromStart: 60, fractionOfMaximum: 0.88 },
      { dayOffsetFromStart: 76, fractionOfMaximum: 0.72 },
      { dayOffsetFromStart: 91, fractionOfMaximum: 0.62 },
      { dayOffsetFromStart: 106, fractionOfMaximum: 0.58 },
      { dayOffsetFromStart: 122, fractionOfMaximum: 0 },
    ],
    "Draft 5/10 fall-entry curve is November-weighted and retains a holding shoulder. Terminal copy ends the fall model without claiming Steelhead left or died.",
  ),
  fishabilityBands: fishability(
...
export const GRAND_CONFIGURATION_DOCUMENT: RiverRunConfigurationDocument = {
  ...
  configVersion: "2026-08-24-grand-phase-c-draft.1",
