...
echo "Test: https://finfindr.app/download (should 302 to Google Play on Android, App Store otherwise)"
echo "Test: https://finfindr.app/get (cross-platform TikTok-safe link-in-bio page, 200 OK)"
echo "Test: https://finfindr.app/app (should 302 to Google Play on Android, App Store otherwise)"
echo "Test: https://finfindr.app/privacy (updated policy, 200 OK)"
echo "Test: https://finfindr.app/creators/ (creator portal removed, 404)"
