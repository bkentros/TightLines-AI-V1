...
echo ""
echo "Supabase Auth → URL Configuration → Redirect URLs (add all, then Save):"
echo "  https://finfindr.app/creators/"
echo "  https://finfindr.app/creators/auth/callback/"
echo "Site URL should be https://finfindr.app/ (root bridge forwards auth tokens to callback)"
