...
const targets: DraftTarget[] = [
  {
    ...
    run: BIG_MANISTEE_FALL_BROWN_TROUT_RUN_PROFILE,
    configVersion: BIG_MANISTEE_CONFIGURATION_DOCUMENT.configVersion,
  },
  ...[
    GRAND_FALL_CHINOOK_RUN_PROFILE,
    GRAND_FALL_COHO_RUN_PROFILE,
  ...
  ...[
    ...
    run,
    configVersion: MIDWEST_DRAFT_CONFIGURATION_DOCUMENTS[0].configVersion,
  })),
  ...[
    KEWAUNEE_FALL_CHINOOK_RUN_PROFILE,
    KEWAUNEE_FALL_COHO_RUN_PROFILE,
    ...
    run,
    configVersion: MIDWEST_DRAFT_CONFIGURATION_DOCUMENTS[1].configVersion,
  })),
];
...
// Do not hand-edit. These release-review fixtures are isolated from live provider inputs.
...
function scenario(
  ...
  return {
    ...
    label,
    note:
      `${target.river.displayName} ${target.run.displayName} release-review fixture`,
    snapshot,
  };
}
