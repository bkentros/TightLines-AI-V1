...
echo ""
echo "  1) When Metro shows a QR code, open it from the dev client scanner if you can,"
echo "     or use Enter URL manually with the link Metro prints (iPhone Camera may reject it)."
